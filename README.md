...
- [实车接入现场操作手册](文档/10_实车接入与动态场景重规划_2026-08-31/实车接入现场操作手册_2026-09-01.md)：从接线、底盘驱动、预检到第一次 1 m 静态目标。
- [笔记本联网断网与离线实车操作手册](文档/10_实车接入与动态场景重规划_2026-08-31/笔记本联网断网与离线实车操作手册_2026-09-01.md)：从公网准备、底盘 Wi-Fi 切换、离线运行到恢复公网和归档。
